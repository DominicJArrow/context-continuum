...
This project uses Context Continuum. Maintain `.continuum/memory.md` (the Board)
...
- **Keep it lean:** the Board is capped at 50 lines. When it grows past that,
...
- **After a reset:** the Board is re-injected automatically. Trust it as your
